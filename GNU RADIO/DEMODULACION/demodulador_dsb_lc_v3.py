...
class demodulador_dsb_lc_v3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "demodulador_dsb_lc_v3")
        ...
        # Variables
        ##################################################
        self.volumen = volumen = 4
        self.samp_rate = samp_rate = 48000
        self.freq_portadora = freq_portadora = 800e3

        ##################################################
        # Blocks
        ##################################################

        self._freq_portadora_range = qtgui.Range(530e3, 1700e3, 10e3, 800e3, 200)
        self._freq_portadora_win = qtgui.RangeWidget(self._freq_portadora_range, self.set_freq_portadora, "Frecuencia Portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._freq_portadora_win)
        self._volumen_range = qtgui.Range(1, 100, 5, 4, 200)
        ...
        self.qtgui_freq_sink_x_0 = qtgui.freq_sink_f(
            ...
            freq_portadora, #fc
            samp_rate, #bw
            "Espectro señal Demodulada", #name
            1,
            None # parent
        )
        ...
        self.blocks_multiply_const_xx_0 = blocks.multiply_const_ff(100000, 1)
        self.blocks_complex_to_mag_0 = blocks.complex_to_mag(1)
        self.audio_sink_0 = audio.sink(samp_rate, '', True)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, freq_portadora, 1, 0, 0)
    ...
    def set_freq_portadora(self, freq_portadora):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq_portadora, self.samp_rate)
        self.rtlsdr_source_0.set_center_freq(self.freq_portadora, 0)




def main(top_block_cls=demodulador_dsb_lc_v3, options=None):
