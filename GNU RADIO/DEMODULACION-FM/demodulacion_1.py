...
class demodulacion_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "demodulacion_1")
        ...
        self.rtlsdr_source_0.set_center_freq(central_freq, 0)
...
def main(top_block_cls=demodulacion_1, options=None):
