...
class moduladorFM_WBFM_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "moduladorFM_WBFM_1")
        ...
        self.analog_wfm_tx_0 = analog.wfm_tx(
        	audio_rate=(samp_rate*2),
        	quad_rate=480000,
        	tau=(75e-6),
        	max_dev=75e3,
        	fh=(-1.0),
        )
        self.analog_fm_preemph_0 = analog.fm_preemph(fs=(samp_rate*2), tau=(75e-6), fh=(-1.0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, (self.samp_rate*2), 100e3, 5e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate)




def main(top_block_cls=moduladorFM_WBFM_1, options=None):
