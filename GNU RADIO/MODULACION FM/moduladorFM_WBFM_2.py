...
class moduladorFM_WBFM_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "moduladorFM_WBFM_2")
        ...
        self.uhd_usrp_sink_0.set_center_freq(86000000, 0)
...
def main(top_block_cls=moduladorFM_WBFM_2, options=None):
